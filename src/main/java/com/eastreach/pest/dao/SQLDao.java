...
public class SQLDao {
    ...
    public List sp_rep_stat_pest_temperature_by_year(String startDt, String endDt, String areaCode, String grainCode, String pestCode, String province, String city, String role, String depotCode) {
        SQLQuery sqlQuery = currentSession().createSQLQuery("{CALL sp_rep_stat_pest_temperature_by_year(?,?,?,?,?,?,?,?,?)}");
        sqlQuery.setString(0, startDt);
        sqlQuery.setString(1, endDt);
        sqlQuery.setString(2, areaCode);
        sqlQuery.setString(3, grainCode);
    ...
    public List sp_rep_stat_pest_humidity_by_year(String startDt, String endDt, String areaCode, String grainCode, String pestCode, String province, String city, String role, String depotCode) {
        SQLQuery sqlQuery = currentSession().createSQLQuery("{CALL sp_rep_stat_pest_humidity_by_year(?,?,?,?,?,?,?,?,?)}");
        sqlQuery.setString(0, startDt);
        sqlQuery.setString(1, endDt);
        sqlQuery.setString(2, areaCode);
        sqlQuery.setString(3, grainCode);
